<div id="SearchBar" class="mt-3 ms-3 ps-1 bg-white rounded shadow-sm" @mousedown.stop>
    <div class="rounded pt-1 mb-2">
        <div class="d-flex justify-content-center align-items-center">
            <span v-if="!showSearchBarLoading" class="ps-4 pe-2">
            ...
            <div v-else class="d-flex justify-content-center ps-4 pe-2">
                <div class="spinner-border spinner-border-sm text-dark-50" role="status">
