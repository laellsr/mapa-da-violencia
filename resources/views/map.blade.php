...
@section('content')
    <div id="app">
        ...
        <div id="boxes-layer">
            ...
            <button type="button" class="btn-mdenunciar" data-bs-toggle="modal" data-bs-target="#denunciarModal">
            ...
            <div id="denunciarModal" class="modal fade" tabindex="-1" aria-labelledby="denunciaModalLabel" aria-hidden="true">
